...
# annotations_filtered  = utils.filter_annotations_v2(annotations_file=segmenter.configs["annotations_file"], 
...
for fish_label in fish_frame_chunks.index:
    ...
    segmenter.add_annotations_v2(annotations=annotation_chunk)

    # Run propagation on annotation chunk of frames
    segmenter.run_propagation_v2(start_frame_idx=enter_frame, max_frame_num_to_track=exit_frame)